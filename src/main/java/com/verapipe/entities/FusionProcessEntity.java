...
public class FusionProcessEntity {
    ...
    private String name;
    @OneToMany(mappedBy = "fusionProcess", cascade = CascadeType.PERSIST, orphanRemoval = true, fetch = FetchType.LAZY)
    private List<ProcessSpecificationProcedureEntity> processSpecificationProceduresList;
    @OneToMany(mappedBy = "fusionProcess", fetch = FetchType.LAZY)
